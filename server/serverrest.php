...
function get_app_by_id($id)
{
  ...
  switch ($id){
    case 1:
      $app_info = array("app_name" => "faizal mutakin", "app_price" => "Free", "app_version" => "2.0"); 
      break;
    case 2:
      $app_info = array("app_name" => "selamat datang", "app_price" => "1144078", "app_version" => "1.1");
      break;
    case 3:
...
function getMahasiswa($id)
{
  ...
  case 1:
      ...
      break;
    case 2:
      $app_info = array( "Nama Barang" => "Budi", "Nama Vendor" => "Cantik", "Qty" => "100","Harga Satuan" => "1000000");
      break;
    case 3:
...
function get_app_list()
{
  //normally this info would be pulled from a database.
  //build JSON array
  $app_list = array(array("id" => 1, "name" => "Web Demo"), array("id" => 2, "name" => "budi"), array("id" => 3, "name" => "The Tab Key"), array("id" => 4, "name" => "Music Sleep Timer")); 
